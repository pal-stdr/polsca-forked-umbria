...
def main():
    ...
    header_guard_name = "_HSI_D_DATA_H"
    data_type_name = "int"
    array_name = "hsi_d_data"
    input_file_path = os.path.abspath(os.path.join(project_root, "example", "PolyBenchC-4.2.1-brain-HSI", "calibration", "input", "organized_ID0067CD02.in"))  # Path to the input file
    # output_file_path = os.path.abspath(os.path.join(project_root, "example", "PolyBenchC-4.2.1-brain-HSI", "calibration", "hsi.d.data.h"))  # Path to the input file
    output_file_path = os.path.abspath(os.path.join(project_root, "example", "PolyBenchC-4.2.1-brain-HSI", "calibration", "hsi.d.data.c"))  # Path to the input file
