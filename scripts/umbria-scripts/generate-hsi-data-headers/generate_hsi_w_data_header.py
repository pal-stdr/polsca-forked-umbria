...
def main():
    ...
    header_guard_name = "_HSI_W_DATA_H"
    data_type_name = "int"
    array_name = "hsi_w_data"
    input_file_path = os.path.abspath(os.path.join(project_root, "example", "PolyBenchC-4.2.1-brain-HSI", "calibration", "input", "organized_ID0067CW02.in"))  # Path to the input file
    # output_file_path = os.path.abspath(os.path.join(project_root, "example", "PolyBenchC-4.2.1-brain-HSI", "calibration", "hsi.w.data.h"))  # Path to the input file
    output_file_path = os.path.abspath(os.path.join(project_root, "example", "PolyBenchC-4.2.1-brain-HSI", "calibration", "hsi.w.data.c"))  # Path to the input file
